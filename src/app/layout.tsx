...
export const metadata: Metadata = {
  ...
  keywords: ["Full-Stack Developer","React","Next.js","Node.js","Pakistan","Lahore","Freelance"],
  ...
  twitter: { card: "summary_large_image", title: siteConfig.title, description: siteConfig.description, creator: "@furqan" },
